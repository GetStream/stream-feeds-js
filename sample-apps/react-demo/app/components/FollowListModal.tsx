...
import type { Feed, UserResponse } from '@stream-io/feeds-react-sdk';
import { useFollowers, useFollowing } from '@stream-io/feeds-react-sdk';
...
export const FollowListModal = forwardRef<FollowListModalHandle, FollowListModalProps>(
  ({ type, feed, currentUserId, isOwnProfile }, ref) => {
    ...
    if (follows) {
      for (const follow of follows) {
        ...
        // Filter out current user when viewing own profile
